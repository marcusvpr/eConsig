package com.mpxds.basic.util.report;
...
public class MpExecutorRelatorioDTO {
	//
	...
	public MpExecutorRelatorioDTO(String caminhoRelatorio,
	...
	public void execute(Collection<Object> data) throws Exception {
		//
		try {
			...
			JasperPrint print = JasperFillManager.fillReport(relatorioStream, this.parametros, datasource);
			...
			e.printStackTrace();
			// throw new Exception("Erro ao executar relatório " + this.caminhoRelatorio, e);
		}
	}
